document.addEventListener('DOMContentLoaded', event => {
  ...
  class FishEgg {
    constructor(canvas) {
      ...
      // Set position
      this.x =
        element.clientWidth / 2 + (Math.random() * 300 - Math.random() * 300);
      this.y =
        element.clientHeight / 2 +
        ((Math.random() * element.clientHeight) / 4 -
          (Math.random() * element.clientHeight) / 4);
      // Get viewport size
  ...
  class FishLarva {
    constructor(canvas, progress) {
      ...
      this.x =
        element.clientWidth / 2 + (Math.random() * 200 - Math.random() * 200);
      this.y =
        element.clientHeight / 2 + (Math.random() * 200 - Math.random() * 200);
